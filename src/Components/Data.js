...
export const projectsData = [
  {
    ...
    description:
      "Moje portfolio to nowoczesna i przejrzysta strona, która w prosty sposób prezentuje moje projekty. Stworzyłem ją przy użyciu Reacta, Motion, Tailwind CSS, React Scroll oraz EmailJS, co zapewnia płynne animacje, elegancki wygląd i intuicyjną nawigację.",
    link: "#",
