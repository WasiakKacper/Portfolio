const Styles = {
  h1: "bg-(--dark) w-240 h-full text-8xl text-(--white) font-bold  flex items-center justify-center tracking-[5px] font-[Jost] rounded-2xl   transition duration-500 ease-in-out",
